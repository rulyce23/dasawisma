...
#rcorners1 {
   ...
   <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <br>
                  <h5 class="card-title">&nbsp;&nbsp;Pemanfaatan Tanah Pekarangan</h5>
		    <div class="card-body">
                  <div class="table-responsive">
                   ...
                   <table id="rcorners1" style="table-layout:auto; width:100%;">
											...
											<br><br>
                                                ...
                                                <tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Peternakan </font></b></td>
												   	   <td>:</td>
                                                 ...
                                                 <tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Perikanan </font></b></td>
												   	   <td>:</td>
												...
												<tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Lumbung Hidup</font></b></td>
												   	   <td>:</td>
												...
												<tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Warung Hidup</font></b></td>
												   	   <td>:</td>
													<td><input type="text" class="form-control"  style=" border-radius:2px; height:20px; font-family:Garamond; " id="no_ktp_kepalarumahtangga" name="no_ktp_kepalarumahtangga"></td>
												...
												<tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Apotik Hidup (TOGA)</font></b></td>
												   	   <td>:</td>
													<td><input type="text" class="form-control"  style=" border-radius:2px; height:20px; font-family:Garamond; " id="no_ktp_kepalarumahtangga" name="no_ktp_kepalarumahtangga"></td>
												...
												<tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Tanaman Produktif</font></b></td>
												   	   <td>:</td>
													<td><input type="text" class="form-control"  style=" border-radius:2px; height:20px; font-family:Garamond; " id="no_ktp_kepalarumahtangga" name="no_ktp_kepalarumahtangga"></td>
												...
												<tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Tanaman Keras atau Pelindung</font></b></td>
												   	   <td>:</td>
													<td><input type="text" class="form-control"  style=" border-radius:2px; height:20px; font-family:Garamond; " id="no_ktp_kepalarumahtangga" name="no_ktp_kepalarumahtangga"></td>
												...
												<tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Tanaman Hias</font></b></td>
												   	   <td>:</td>
													<td><input type="text" class="form-control"  style=" border-radius:2px; height:20px; font-family:Garamond; " id="no_ktp_kepalarumahtangga" name="no_ktp_kepalarumahtangga"></td>
												...
												<tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Tanaman Buah Dalam Pot</font></b></td>
												   	   <td>:</td>
													<td><input type="text" class="form-control"  style=" border-radius:2px; height:20px; font-family:Garamond; " id="no_ktp_kepalarumahtangga" name="no_ktp_kepalarumahtangga"></td>
                                                ...
                                                <tr>
												<div class="row">
                                                 	<td><input type="text" class="form-control"  style=" border-radius:2px;  height:26px; font-family:Garamond;" id="no_survey" name="no_survey"></td>
												
													</div>
                                                </tr>
                                                 <tr>
												<div class="row">
                                                 	<td><input type="text" class="form-control"  style="border-radius:2px;  height:26px; font-family:Garamond;" id="nama_kepalarumahtangga" name="nama_kepalarumahtangga"></td>
												
													</div>
                                                </tr>
												<tr>
												<div class="row">
                                                	<td><input type="text" class="form-control"  style=" border-radius:2px; height:26px; font-family:Garamond; " id="no_ktp_kepalarumahtangga" name="no_ktp_kepalarumahtangga"></td>
											  ...
											  <button type="submit" class="btn btn-success">Simpan</button> 
												<a href="<?php echo site_url('admin/rumtinggal/deleteptp') ?>" class="btn btn-warning">Hapus</a>
