...
#rcorners1 {
   ...
   <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <br>
                  <h5 class="card-title">&nbsp;&nbsp;UP2K (Usaha Peningkatan & Pendapatan Keluarga)</h5>
		    <div class="card-body">
                  <div class="table-responsive">
                   ...
                   <table id="rcorners1" style="table-layout:auto; width:100%;">
											...
											<br><br>
                                                ...
                                                <tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Warung </font></b></td>
												   	   <td>:</td>
												...
												<tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Kerajinan</font></b></td>
												   	   <td>:</td>
												...
												<tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Jahit</font></b></td>
												   	   <td>:</td>
													<td><input type="text" class="form-control"  style=" border-radius:2px; height:20px; font-family:Garamond; " id="no_ktp_kepalarumahtangga" name="no_ktp_kepalarumahtangga"></td>
												...
												<tr>
												<div class="row">
                                                   <td><font size="2px"><b>&nbsp;&nbsp;&nbsp;&nbsp; Lain-Lain</font></b></td>
												   	   <td>:</td>
													<td><input type="text" class="form-control"  style=" border-radius:2px; height:20px; font-family:Garamond; " id="no_ktp_kepalarumahtangga" name="no_ktp_kepalarumahtangga"></td>
														 ...
														 <table id="rcorners1" style="table-layout:auto; width:48%; height:55%;" align="right">
